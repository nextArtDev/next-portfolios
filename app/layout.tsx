      ...
      >
        <ThemeContextProvider>
          <ActiveSectionContextProvider>
            <Header />
            <div className="absolute inset-0 -z-10 h-full w-full bg-white dark:bg-gray-900  dark:bg-[radial-gradient(#4a4b4d55_1px,transparent_1px)] bg-[radial-gradient(#e5e7eb_1px,transparent_1px)] [background-size:16px_16px]" />
